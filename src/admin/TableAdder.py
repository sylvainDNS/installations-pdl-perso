...
def addInstallations(my_cursor, id, nom, adresse, code_postal, ville, latitude, longitude):
    my_cursor.execute('INSERT OR IGNORE INTO installations (id, nom, adresse, code_postal, ville, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?, ?)', (id, nom, adresse, code_postal, ville, latitude, longitude))
